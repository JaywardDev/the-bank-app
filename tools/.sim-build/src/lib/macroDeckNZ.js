...
exports.drawNZMacroCard = exports.NZ_MACRO_DECK = void 0;
exports.NZ_MACRO_DECK = [
    {
        id: "steady-growth",
        ...
        flavor: "A steady flow of travellers fills rentals and boosts confidence in local property markets.",
    ...
    },
    {
        ...
        flavor: "As the Reserve Bank steadies policy, borrowers get more breathing room each round.",
    ...
    },
    {
        ...
        flavor: "Hold-ups through major ports push up construction inputs across the country.",
    ...
    },
    {
        ...
        flavor: "With supply moving faster, builders compete harder and costs come down.",
    ...
    },
    {
        ...
        flavor: "Tenants gain leverage, and landlords across Aotearoa trim asking rents.",
    ...
    },
    {
        ...
        flavor: "Banks pass through tighter monetary conditions as lending appetite cools.",
    ...
    },
    {
        ...
        flavor: "Lenders focus on balance-sheet resilience and halt fresh mortgage exposure.",
    ...
    },
    {
        ...
        flavor: "Households feel optimistic, and cash circulates quickly through local businesses.",
    ...
    },
    {
        ...
        flavor: "Emergency relief lands at once, lifting short-term liquidity across the board.",
    ...
    },
    {
        ...
        flavor: "Policy support ramps up quickly to keep markets liquid and credit flowing.",
    ...
    },
    {
        ...
        flavor: "Public finances tighten and everyone contributes at once.",
    ...
    },
    {
        ...
        flavor: "Transport links run hot as seasonal demand boosts rail and ferry turnover.",
    ...
    },
    {
        ...
        flavor: "Tight generation margins raise utility returns, amplified by housing density.",
    ...
    },
    {
        ...
        flavor: "Risk appetite vanishes and landlords compete aggressively to hold tenants.",
    ...
    },
    {
        ...
        flavor: "Funding costs rise as debt markets demand higher returns for risk.",
    ...
    },
    {
        ...
        flavor: "Damage assessments trigger immediate repair costs tied to local housing density.",
    ...
    },
    {
        ...
        flavor: "Highly leveraged players face instant scrutiny on their largest obligations.",
    ...
    },
    {
        ...
        flavor: "Economic activity pauses abruptly, but support payments arrive to cushion households.",
        rulesText: "All players skip their next roll. Loans and mortgages still tick. Each player receives NZ$240,000 stimulus.",
        effects: {
            pandemic: {
                skipNextRoll: true,
    ...
    },
    {
        ...
        flavor: "Liquidity tightens and players may need to liquidate housing to stay solvent.",
        rulesText: "Each player pays NZ$480,000 immediately. If cash is insufficient, liquidate houses until covered.",
        effects: {
            sovereign_default: {
                cashDelta: -480_000,
    ...
    },
    {
        ...
        flavor: "Transaction volume spikes, restoring full resale liquidity on houses for a short window.",
    ...
    },
    {
        ...
        flavor: "Strengthening, inspections, and fixes hit multiple regions at once.",
        rulesText: "Two random colour sets are affected. Owners pay NZ$120,000 per house in those sets.",
    ...
    },
    {
        ...
        flavor: "Credit committees tighten up and approvals stop temporarily.",
...
const drawNZMacroCard = (lastCardId) => {
    if (exports.NZ_MACRO_DECK.length === 0) {
        throw new Error("NZ macro deck is empty.");
    }
    const filtered = lastCardId == null
        ? exports.NZ_MACRO_DECK
        : exports.NZ_MACRO_DECK.filter((card) => card.id !== lastCardId);
    const candidates = filtered.length > 0 ? filtered : exports.NZ_MACRO_DECK;
    return pickWeighted(candidates);
};
exports.drawNZMacroCard = drawNZMacroCard;
