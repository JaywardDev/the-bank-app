...
exports.drawMacroCardPhV1 = exports.MACRO_DECK_PH_V1 = void 0;
exports.getMacroCardByIdPhV1 = getMacroCardByIdPhV1;
exports.MACRO_DECK_PH_V1 = [
    {
        id: "steady-growth",
        name: "Steady Growth",
        rarity: "common",
    ...
    },
    {
        ...
        rulesText: "Each player receives ₱400,000 immediately.",
        effects: {
            cash_delta: 400000,
        },
    },
    {
        ...
        rulesText: "Each player receives ₱800,000 immediately.",
        effects: {
            cash_delta: 800000,
        },
    },
    {
        ...
        rulesText: "Each player receives ₱1,200,000 immediately.",
        effects: {
            cash_delta: 1200000,
        },
    },
    {
        ...
        rulesText: "Each player pays ₱800,000 immediately.",
        effects: {
            cash_delta: -800000,
        },
    },
    ...
    },
    {
        ...
        rulesText: "Randomly select 2 color sets. Pay ₱400,000 per house on properties in those sets.",
        effects: {
            regional_disaster: {
                colorSets: 2,
                costPerHouse: 400000,
    ...
    },
    {
        ...
        rulesText: "All players skip their next roll. Loans and mortgages still tick. Each player receives ₱800,000 stimulus.",
        effects: {
            pandemic: {
                skipNextRoll: true,
                stimulusCash: 800000,
    ...
    },
    {
        ...
        rulesText: "Each player pays ₱1,600,000 immediately. If cash is insufficient, liquidate houses until covered.",
        effects: {
            sovereign_default: {
                cashDelta: -1600000,
...
const drawMacroCardPhV1 = (lastCardId) => {
    if (exports.MACRO_DECK_PH_V1.length === 0) {
        throw new Error("Macro deck ph v1 is empty.");
    }
    const filtered = lastCardId == null
        ? exports.MACRO_DECK_PH_V1
        : exports.MACRO_DECK_PH_V1.filter((card) => card.id !== lastCardId);
    const candidates = filtered.length > 0 ? filtered : exports.MACRO_DECK_PH_V1;
    return pickWeighted(candidates);
};
exports.drawMacroCardPhV1 = drawMacroCardPhV1;
function getMacroCardByIdPhV1(id) {
    return exports.MACRO_DECK_PH_V1.find((card) => card.id === id);
}
