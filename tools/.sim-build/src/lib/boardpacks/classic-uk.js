...
exports.classicUkBoardPack = exports.CLASSIC_UK_PROPERTY_GROUPS = exports.classicUkCommunityCards = exports.classicUkChanceCards = exports.CLASSIC_UK_ECONOMY = void 0;
const macroDeckV1_1 = require("../macroDeckV1");
...
const applyPropertyGroupConfig = (tiles, groups, economy) => tiles.map((tile) => {
    ...
    return {
        ...
        rentByHouses: tile.rentByHouses ?? buildRentByHouses(baseRent, rentMultipliers),
    };
});
exports.CLASSIC_UK_ECONOMY = {
    currency: {
        code: "GBP",
        symbol: "£",
    },
...
exports.classicUkChanceCards = [
    ...
    {
        id: "classic-uk-chance-tax-exemption-pass-1",
    ...
    {
        id: "classic-uk-chance-tax-exemption-pass-2",
        title: "Tax Exemption Pass",
        text: "Keep this card until needed. Use it to avoid paying Income Tax or Super Tax when you land on a tax tile.",
        kind: "TAX_EXEMPTION_PASS",
        payload: {},
...
exports.CLASSIC_UK_PROPERTY_GROUPS = [
...
exports.classicUkBoardPack = {
    id: "classic-uk",
    displayName: "Classic (UK)",
    properties: [],
    economy: exports.CLASSIC_UK_ECONOMY,
    macroDeck: {
        id: "macro-v1",
        name: "Macro V1",
        cards: macroDeckV1_1.MACRO_DECK_V1,
        draw: macroDeckV1_1.drawMacroCardV1,
    },
    eventDecks: {
        chance: exports.classicUkChanceCards,
        community: exports.classicUkCommunityCards,
    },
    tiles: applyPropertyGroupConfig([
        ...
        { index: 12, tile_id: "electric-company", type: "UTILITY", utilityKind: "ELECTRIC", name: "Electric Company", price: 150 },
        ...
        { index: 28, tile_id: "water-works", type: "UTILITY", utilityKind: "WATER", name: "Water Works", price: 150 },
    ...
    ], exports.CLASSIC_UK_PROPERTY_GROUPS, exports.CLASSIC_UK_ECONOMY),
};
