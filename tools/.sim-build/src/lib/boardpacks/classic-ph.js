...
exports.classicPhBoardPack = exports.classicPhCommunityCards = exports.classicPhChanceCards = void 0;
const classic_uk_1 = require("./classic-uk");
...
const CLASSIC_PH_ECONOMY = {
    ...classic_uk_1.CLASSIC_UK_ECONOMY,
    currency: {
        code: "PHP",
        symbol: "₱",
    },
...
const CLASSIC_PH_PROPERTY_GROUPS = [
...
exports.classicPhChanceCards = [
    ...
    {
        id: "classic-ph-chance-tax-exemption-pass-1",
    ...
    {
        id: "classic-ph-chance-tax-exemption-pass-2",
        title: "Tax Exemption Pass",
        text: "Keep this card until needed. Use it to avoid paying Income Tax or Super Tax when you land on a tax tile.",
        kind: "TAX_EXEMPTION_PASS",
        payload: {},
...
exports.classicPhCommunityCards = [
    {
...
exports.classicPhBoardPack = {
    ...
    macroDeck: {
        id: "macro-ph-v1",
        name: "Macro PH V1",
        cards: macroDeckPhV1_1.MACRO_DECK_PH_V1,
        draw: macroDeckPhV1_1.drawMacroCardPhV1,
    },
    eventDecks: {
        chance: exports.classicPhChanceCards,
        community: exports.classicPhCommunityCards,
    },
    tiles: applyPropertyGroupConfig([
        ...
        { index: 12, tile_id: "meralco", type: "UTILITY", utilityKind: "ELECTRIC", name: "MERALCO", price: 1200000 },
        ...
        { index: 28, tile_id: "manila-water", type: "UTILITY", utilityKind: "WATER", name: "Manila Water", price: 1200000 },
